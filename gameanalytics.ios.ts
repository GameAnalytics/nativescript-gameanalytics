...
export class GameAnalyticsSDK {
    ...
    {
        //GameAnalyticsAndroid.configureSdkGameEngineVersion("nativescript " + VERSION);
        //GameAnalyticsAndroid.configureGameEngineVersion("nativescript " + NATIVESCRIPT_VERSION);
